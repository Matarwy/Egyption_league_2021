...
public class adminDeleteFrame extends Frame implements ActionListener{
    ...
    JComboBox<String> deletePlayer_T_i;
    JTextField deletePlayer_i;

    JLabel deletePlyer_T_l;
    JLabel deletePlayer_l;
    JLabel deletePlayer_i_valid_info;
    ...
    JLabel deleteMatch_l1 = new JLabel("Match Team 1");
    JLabel deleteMatch_l2 = new JLabel("Match Team 2");
    ...
    public adminDeleteFrame(){
        super();
        deleteButton1 = new JButton("Delete The Player");
        deletePlayer_i = new JTextField();
        deletePlayer_T_i = new JComboBox();
        deletePlyer_T_l = new JLabel("Team Index");
        deletePlayer_l = new JLabel("Player");
        deletePlayer_i_valid_info = new JLabel("");
         
         deleteButton2 = new JButton("Delete The Team");
        //Delete Player Panel-----------------------------------
